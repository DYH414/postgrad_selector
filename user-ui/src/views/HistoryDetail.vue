...
function normalizeResult(payload) {
  ...
  return {
    ...
    steady: groupItems(groups, 'steady'),
    focus: groupItems(groups, 'balanced_sprint'),
    reach: groupItems(groups, 'sprint'),
    insufficient: groupItems(groups, 'insufficient_data')
  }
}
...
onMounted(() => {
  ...
  if (id) {
    ...
    getRecommendationHistoryDetail(id).then(res => {
      ...
      result.value = payload && payload.groups ? normalizeResult(payload) : payload
