  ...
  <div class="ai-history-page">
    ...
    <div class="page-body">
      <div class="page-title">
        <h2>AI 推荐报告记录</h2>
        <el-button type="primary" size="small" icon="el-icon-plus" @click="$router.push('/app/recommend')">
          新建推荐
        </el-button>
      </div>
      ...
      <div v-loading="loading" class="report-list">
        ...
        <div v-for="report in reports" :key="report.id" class="report-card"
          @click="$router.push('/app/ai-report/' + report.id)">
          <div class="card-main">
...
import { getAiReports } from '@/api/postgrad/ai'
  ...
  methods: {
    async fetchReports() {
      ...
      try {
        ...
        this.reports = raw.map(r => this.parseReport(r))
      } catch (e) {
