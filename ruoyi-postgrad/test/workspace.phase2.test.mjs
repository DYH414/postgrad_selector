...
const expectations = [
  ...
  [mapper.includes('@Param("is408") String is408'), 'school workspace stats should accept the 408 filter'],
  [mapper.includes('@Param("completeness") String completeness'), 'school workspace stats should accept the completeness filter'],
  [mapperXml.includes('<sql id="DynamicCompletenessLevel">'), 'mapper XML should centralize dynamic completeness SQL'],
  [mapperXml.includes('<sql id="NnuoCompletenessLevel">'), 'mapper XML should centralize Nnuo-scoped completeness SQL'],
  [mapperXml.includes('<sql id="NnuoScoreSource">'), 'mapper XML should centralize Nnuo score source filters'],
  [mapperXml.includes('<sql id="NnuoPlanSource">'), 'mapper XML should centralize Nnuo plan source filters'],
  [mapperXml.includes('<sql id="NnuoResultSource">'), 'mapper XML should centralize Nnuo result source filters'],
  [mapperXml.includes('<sql id="NnuoProgramYearOnly">'), 'mapper XML should filter workspace denominator to Nnuo program-year data'],
  [mapperXml.includes("ds.source_owner like 'N诺%'"), 'mapper XML should scope workspace data to Nnuo source owner'],
