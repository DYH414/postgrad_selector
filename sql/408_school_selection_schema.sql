...
CREATE TABLE user_profile (
  ...
  priority_preference ENUM('success_rate','school_tier','developed_region','major_strength') NULL COMMENT '择校最看重',
  school_tier_preference ENUM('must_211_or_better','prefer_211_or_better','no_strict_requirement') NULL COMMENT '学校层次倾向',
  region_strategy ENUM('no_limit','developed_regions','specific_regions','near_home') NULL COMMENT '地区策略',
  data_reliability_preference ENUM('strict','medium','loose') NULL COMMENT '数据可靠性偏好',
